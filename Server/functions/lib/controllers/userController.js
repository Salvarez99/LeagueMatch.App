...
var UserController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userDTO = req.body;
                        return [4 /*yield*/, userService_1.userService.addUser(userDTO)];
                    case 1:
                        createdUser = _a.sent();
    ...
    UserController.prototype.updateUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, uid, username, riotId, updatedUser, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = req.body, uid = _a.uid, username = _a.username, riotId = _a.riotId;
                        return [4 /*yield*/, userService_1.userService.updateUser(uid, username, riotId)];
                    case 1:
                        updatedUser = _b.sent();
                        return [2 /*return*/, res.status(200).json({
                                success: true,
